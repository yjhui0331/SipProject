...
static void ui_add_account(pjsua_transport_config *rtp_cfg)
{
	...
	*/
	...
	pjsua_acc_config_default(&acc_cfg);
	acc_cfg.id = pj_str("sip:5011@192.168.50.200:5060");
	acc_cfg.reg_uri = pj_str("sip:5011@192.168.50.200:5060");
	acc_cfg.cred_count = 2;
	acc_cfg.cred_info[0].scheme = pj_str("Digest");
	//acc_cfg.cred_info[0].realm = pj_str("ASG Switch");
	acc_cfg.cred_info[0].realm = pj_str("*");
	acc_cfg.cred_info[0].username = pj_str("5011");
	acc_cfg.cred_info[0].data_type = 0;
	acc_cfg.cred_info[0].data = pj_str("5011");
