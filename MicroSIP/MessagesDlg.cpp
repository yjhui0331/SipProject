...
BOOL MessagesDlg::OnInitDialog()
{
	...
	imageList.Add((HICON)LoadImage(
		AfxGetInstanceHandle(),
		MAKEINTRESOURCE(IDI_CALL_OUT),
		IMAGE_ICON, 0, 0, LR_SHARED ));
	imageList.Add((HICON)LoadImage(
		AfxGetInstanceHandle(),
		MAKEINTRESOURCE(IDI_CALL_IN),
		IMAGE_ICON, 0, 0, LR_SHARED ));
	imageList.Add((HICON)LoadImage(
		AfxGetInstanceHandle(),
		MAKEINTRESOURCE(IDI_CALL_MISS),
		IMAGE_ICON, 0, 0, LR_SHARED ));
	imageList.Add((HICON)LoadImage(
		AfxGetInstanceHandle(),
	...
	imageList.Add((HICON)LoadImage(
		AfxGetInstanceHandle(),
		MAKEINTRESOURCE(IDI_ACTIVE_SECURE),
		IMAGE_ICON, 0, 0, LR_SHARED ));
	imageList.Add((HICON)LoadImage(
		AfxGetInstanceHandle(),
		MAKEINTRESOURCE(IDI_CONFERENCE),
		IMAGE_ICON, 0, 0, LR_SHARED ));
	imageList.Add((HICON)LoadImage(
		AfxGetInstanceHandle(),
		MAKEINTRESOURCE(IDI_CONFERENCE_SECURE),
		IMAGE_ICON, 0, 0, LR_SHARED ));
	imageList.Add((HICON)LoadImage(
		AfxGetInstanceHandle(),
		MAKEINTRESOURCE(IDI_MESSAGE_IN),
		IMAGE_ICON, 0, 0, LR_SHARED ));
	imageList.Add((HICON)LoadImage(
		AfxGetInstanceHandle(),
		MAKEINTRESOURCE(IDI_ON_HOLD),
		IMAGE_ICON, 0, 0, LR_SHARED ));
	imageList.Add((HICON)LoadImage(
		AfxGetInstanceHandle(),
		MAKEINTRESOURCE(IDI_ON_REMOTE_HOLD),
		IMAGE_ICON, 0, 0, LR_SHARED ));
	imageList.Add((HICON)LoadImage(
		AfxGetInstanceHandle(),
		MAKEINTRESOURCE(IDI_ON_REMOTE_HOLD_CONFERENCE),
		IMAGE_ICON, 0, 0, LR_SHARED ));
	...
	m_hIconDropDown = (HICON)LoadImage(
		AfxGetInstanceHandle(),
...
void MessagesDlg::OnChangeTab(pjsua_call_info *p_call_info)
{
	...
	if (messagesContact->hasNewMessages) {
		...
		UpdateTabIcon(messagesContact,tab->GetCurSel(),p_call_info);
	}
