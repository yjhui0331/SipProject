                              ...
                              pjmedia_vid_packing packing)
{
	...
	/*
	encode decode test: codec=h264, packing=framed
	starting codec test: I420<->H264 720x480
	ssertion failed: !"Insufficient H.264 bitstream buffer", file ..\src\pjmedia-co
	ec\h264_packetizer.c, line 396
	*/
